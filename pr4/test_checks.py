...
def test_homogeneidad_islas(islas_raw):
    ...
    # islas_raw = pd.concat([islas_raw, pd.DataFrame({"isla": ["tenerife"]})], ignore_index=True)
    # --------------------------------------------------
    ...
    return AssetCheckResult(
        ...
        metadata={
            ...
            "principio_gestalt": "Semejanza (Evitar fragmentación visual)",
            "mensaje": "La redundancia léxica crea duplicados innecesarios en la leyenda."
        }
    )